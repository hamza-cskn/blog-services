<script>
    ...
    onMount(() => {
        toggleFullScreen = () => {
            const elem = document.getElementById("blog-edit-area");
            elem.width = 900;
        }
    })
</script>
<div class="flex items-center justify-between px-3 py-2 border-b dark:border-gray-600">
    ...
    <div on:click={toggleFullScreen} id="tooltip-fullscreen" role="tooltip" class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
        Show full screen
